                ...
                <div className="flex-grow overflow-auto p-6 space-y-6">
                    {messages.map((m, idx) => {
                        if (m.role === 'assistant') {
                            ...
                            if (parsed) {
                                return (
                                    <div key={idx} className="flex justify-start items-end w-full">
                                        <img
                                            src="/chatimusPFP.jpg"
                                            alt="Chatimus Profile"
                                            className="w-10 h-10 rounded-full border-2 shadow mr-2 object-cover"
                                            style={{ minWidth: '40px', minHeight: '40px', borderColor: '#D31710', alignSelf: 'flex-start' }}
                                        />
                                        <div
                                            className="relative flex items-end max-w-2/3"
                                            style={{ maxWidth: '66%', marginLeft: '12px' }}
                                        >
                                            <div
                                            ...
                                            >
                                                <span className="text-left w-full" style={{ wordBreak: 'break-word' }}>
                                                    {parsed.summary ? (
                                                        <ReactMarkdown
                                                            components={{
                        ...
                        // User bubble with profile picture on the right
                        return (
